...
### [**Adachi Ward**](https://github.com/markdown-arch-bugyo/open-arch-reiki/tree/main/21_Adachi-ku)
- 足立区建築基準法施行細則
- 足立区緑の保護育成条例
- 足立区緑の保護育成条例施行規則
- 足立区景観条例
...
### [足立区](https://github.com/markdown-arch-bugyo/open-arch-reiki/tree/main/21_Adachi-ku)
- 足立区建築基準法施行細則
- 足立区緑の保護育成条例
- 足立区緑の保護育成条例施行規則
- 足立区景観条例
